...
if __name__ == '__main__':
    ...
    for i in range(1, 29):
        ...
        global_outliers_dims = [1, 3, 5, 7, 9, 11, 15, 17, 25, 28, 29]
        contextual_outliers_dims = [0, 2, 4, 12, 18, 30, 35, 38]

        multivariate_data.point_global_outliers(dim_nos=global_outliers_dims, ratio=0.0005, factor=3, radius=10)
        multivariate_data.point_global_outliers(dim_nos=global_outliers_dims, ratio=0.0005, factor=3, radius=40)
