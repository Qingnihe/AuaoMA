...
with open('application-server-dataset/application-server-dataset-train.json', 'r') as file:
    train_data = json.load(file)

with open('application-server-dataset/application-server-dataset-test.json', 'r') as file:
    test_data = json.load(file)

dataset = "application-server-dataset"
